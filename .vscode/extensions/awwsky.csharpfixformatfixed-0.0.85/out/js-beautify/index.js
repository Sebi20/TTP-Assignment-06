...
(function () {
        ...
        function js_beautify(js_source_text, options) {
            ...
            function Beautifier(js_source_text, options) {
                ...
                opt.space_in_empty_paren = (options.space_in_empty_paren === undefined) ? true : options.space_in_empty_paren;
                ...
                function handle_whitespace_and_comments(local_token, preserve_statement_flags) {
                    ...
                    /*
                    function print_newline(force_newline, preserve_statement_flags, intend_line = false) {
                    ...
                    */
                    ...
                    if (keep_whitespace) {
                        for (var i = 0; i < newlines; i += 1) {
                            ...
                            if (newlines > 1) {
                                var mod = output.previous_line.last() == '{' ? 1 : 0;

                                output.set_indent(output.previous_line.get_indent() + mod);
                            }
                        }
                    } else {
            ...
            function allow_wrap_or_preserved_newline(force_linewrap) {
                ...
                if (operatorLogicApplies) {
                    var shouldPrintOperatorNewline = (in_array(flags.last_text, Tokenizer.positionable_operators) &&
            ...
            function start_of_statement() {
                if ((last_type === 'TK_RESERVED' && in_array(flags.last_text, ['var', 'let', 'const']) && current_token.type === 'TK_WORD') ||
                    ...
                    if (!start_of_object_property()) {
                        allow_wrap_or_preserved_newline(current_token.type === 'TK_RESERVED' && in_array(current_token.text, ['do', 'for', 'foreach', 'if', 'while']));
                    }
                    return true;
                }
                return false;
            ...
            function handle_start_block() {
                ...
                if (second_token && ((in_array(second_token.text, [':', ',']) && in_array(next_token.type, ['TK_STRING', 'TK_WORD', 'TK_RESERVED'])) ||
            ...
            function handle_operator() {
                ...
                var isUnary = in_array(current_token.text, ['-', '+']) && (in_array(last_type, ['TK_START_BLOCK', 'TK_START_EXPR', 'TK_EQUALS', 'TK_OPERATOR']) ||
        ...
        function OutputLine(parent) {
            ...
            this.toString = function () {
                ...
                if (!this._empty) {
                    ...
                    result += _items.join('');
                    if (initialIntend == 0) {
                        //result.set_indent(lastIntendCount);

                        for (var i = 0; i < lastIntendCount - 1; i++) {
                            result += parent.indent_string;
                        }

                        //result += "// " + lastIntendCount;
                    }
                    lastIntendCount = initialIntend;
                }
                return result;
            };
        }
